...
<body>
    ...
    <div class="container">
        ...
        <form method="POST" action="">
            ...
            <div class="d-flex justify-content-center">
                <div class="mb-3 col-2">
                    ...
                    <input type="tel" class="form-control" name="Telefone" id="Telefone" maxlength="15" onkeyup="handlePhone(event)" value="<?php echo $_REQUEST["Telefone"] ?>" required>
                </div>
            </div>
        ...
        <p align=center><a href='tabela.php' class="btn btn-dark">Tabela</a></p>
    </div>
</body>
